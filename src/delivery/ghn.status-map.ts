...
export const GHN_STATUS_MAP: Record<string, GhnStatusMapping> = {
  ...
  waiting_to_return: { delivery: DeliveryStatus.RETURNING },
  return: { delivery: DeliveryStatus.RETURNING },
  return_transporting: { delivery: DeliveryStatus.RETURNING },
  return_sorting: { delivery: DeliveryStatus.RETURNING },
  returning: { delivery: DeliveryStatus.RETURNING },
  return_fail: { delivery: DeliveryStatus.FAILED },
  returned: { delivery: DeliveryStatus.RETURNED },
  cancel: { delivery: DeliveryStatus.CANCELLED },
